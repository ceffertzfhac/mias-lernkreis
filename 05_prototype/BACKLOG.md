...
| **L1** | Feedback-Animation nach jeder Aufgabe/Frage — Score-Delta als fliegende Zahl: grün „+8" bei richtig, rot „−10" bei falsch, grau „±0" bei neutral; Animation: aufsteigen + fade-out, sofort sichtbar nach Bewertung (Üben + Verifikation) | offen |

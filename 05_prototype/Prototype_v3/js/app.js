...
function app() {
  return {
    ...
    // ════════════════════════════════════════════════════════════════════════
    goTo(screen) {
      // Pulse radar when returning home after exercises
      if (screen === 'home' && ['ueben-aufgabe','ueben-ergebnis'].includes(this.screen) && this.session.aufgaben.length > 0) {
        setTimeout(() => { this.radarPulse = true; setTimeout(() => { this.radarPulse = false }, 900) }, 300)
      }
      radar.destroyAll()
